...
import { changePasswordSchema, emailSchema, passwordSchema } from '@auth/validators/password';
...
import { BadRequestError, IAuthDocument, IEmailMessageDetails } from '@chandrashekar2001/ecommerce-shared';
